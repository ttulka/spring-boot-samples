...
/**
 * Auto-configuration disabled. {@link EnableWebMvc standard web configuration} enabled.
 * <p>
 * The imported {@link DelegatingWebMvcConfiguration web configuration} collects instances of the custom {@link WebMvcConfigurer configurer}.
 */
@SpringBootTest(
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
        classes = {SampleController.class, WebMvcConfigurerEnableWebMvcTest.MessageConvertersConfig.class})
@EnableAutoConfiguration(
        exclude = {WebMvcAutoConfiguration.class, HttpMessageConvertersAutoConfiguration.class})
@EnableWebMvc
public class WebMvcConfigurerEnableWebMvcTest {
    ...
    @Configuration
    static class MessageConvertersConfig implements WebMvcConfigurer {

        // Doesn't work (JSON test fails) - default converters are not set.
//        @Override
...
//        }
        ...
        public void extendMessageConverters(List<HttpMessageConverter<?>> converters) {
            ...
            // To overwrite the default, the custom converter must be put at the beginning of the list.
